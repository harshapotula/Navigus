...
<body>
   <!-- <nav class="navbar navbar-default title1">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light pagination text-danger">
  <div class="container-fluid">
    
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="nav navbar-nav">
    <li class="page-item" <?php if(@$_GET['q']==1) echo'class="active"'; ?> ><a class="page-link" href="welcome.php?q=1"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;Home<span class="sr-only">(current)</span></a></li>
            <li class="page-item" <?php if(@$_GET['q']==2) echo'class="active"'; ?>> <a class="page-link" href="welcome.php?q=2"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span>&nbsp;History</a></li>
            <li class="page-item" <?php if(@$_GET['qs']==3) echo'class="active"'; ?>> <a class="page-link" href="welcome.php?q=3"><span class="glyphicon glyphicon-stats" aria-hidden="true"></span>&nbsp;Ranking</a></li>
                </ul>
